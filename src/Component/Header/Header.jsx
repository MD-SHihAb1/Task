        ...
        <div>
            <div>
                ...
                <div className="card-body">
                    ...
                    <br />
                    <br />
                    <p className="text-center text-2xl font-poppins">Find Best Place, Restaurant, Hotel, Real State and many more think in just One click</p>
                    <br />
                    <br />
                    <h1 className="bg-white h-20 text-2xl text-black  w-3/4 ">
                   ...
                   <div className="">
                     <div className="flex my-5 mx-8  rounded-3xl ">
                        ...
                        <input type="text" name="" placeholder="Ex: Place,Resturent,Food " id="" />
                        </div>
                        ...
                        <input type="text" name="" placeholder="Ex: London, Newyork" id="" />
                        </div>
                    ...
                    <div className="card w-96 bg-base-200 text-neutral-content hover:bg-red-400">
                        <div className="card-body items-center text-center">
                            <h2 className="card-title"><BsFillHouseDoorFill className="text-6xl text-black hover:scale-105"></BsFillHouseDoorFill></h2>
