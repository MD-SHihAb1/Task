...
const Login = () => {
    ...
    const {singINUser, signWithGoogle, signWithGithub} = useContext(AuthContext);
        ...
        <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col">
                ...
                <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                    ...
                    <p className="mt-4 text-center">Don't Have An Account? <Link to="/register" className="btn btn-link">Register</Link></p>
